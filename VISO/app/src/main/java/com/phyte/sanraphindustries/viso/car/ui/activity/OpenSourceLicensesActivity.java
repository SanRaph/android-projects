...
/**
 * Application Name: WagesRecords
 * Package name: com.classic.wages.ui.activity
 *
 * File Description: Open Source Code License
 * Creator: Write a classic
 * Creation time: 2016/10/26 18:40
 */
public class OpenSourceLicensesActivity extends AppBaseActivity implements CommonRecyclerAdapter.OnItemClickListener{
    ...
    static {
        LICENSE_ARRAY.add(new LicenseItem("CommonAdapter", "Continue writing classic", LICENSE_TYPE_MIT,
                                          "https://avatars1.githubusercontent.com/u/10043599?v=3&s=466",
                                          "https://github.com/qyxxjd/CommonAdapter"));
        LICENSE_ARRAY.add(new LicenseItem("BaseProject", "Continue writing classic", LICENSE_TYPE_MIT,
                                          "https://avatars1.githubusercontent.com/u/10043599?v=3&s=466",
        ...
        LICENSE_ARRAY.add(new LicenseItem("MaterialEditText", "Throwline", LICENSE_TYPE_APACHE,
